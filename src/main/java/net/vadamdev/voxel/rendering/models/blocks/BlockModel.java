...
public class BlockModel {
    ...
    public void bake(ChunkMesh.Data meshData, int dX, int dY, int dZ, int adjacentBlocks, AOBlockGroup.Face[] aoGroups) {
        for(VoxelFactory voxel : voxels)
            voxel.bakeVerticesToWorld(meshData, dX, dY, dZ, adjacentBlocks, aoGroups);
    }

    public void bake(ChunkMesh.Data meshData, int dX, int dY, int dZ, int adjacentBlocks) {
